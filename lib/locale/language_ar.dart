...
class LanguageAr extends BaseLanguage {
  ...
  @override
  String get lblSkipIntro => 'يتخطى المقدمة';
  @override
  String get lblSkipRecap => 'يتخطى الملخص';
  ...
  @override
  String get noSearchResultsFound => 'لم يتم العثور على نتائج بحث';
  ...
  @override
  String get trySearchingForSomething => 'حاول البحث عن شيء آخر.';

  @override
  String get pleaseSubscribeOrUpgrade =>
      'يرجى الاشتراك أو ترقية خطتك باستخدام جهاز محمول أو تسجيل الدخول إلى الويب لمشاهدة هذا المحتوى.';

  @override
  String get fromRecentSearches => 'من عمليات البحث الأخيرة';

  @override
  String get scanQRBelowToLogin => 'قم بمسح QR أدناه لتسجيل الدخول';

  @override
  String get scanQrToLogin => 'مسح QR لتسجيل الدخول';

  @override
  String get goToYourProfile => 'انتقل إلى ملف التعريف الخاص بك';

  @override
  String get clickOnLinkTvButton => 'انقر على قسم "تفعيل التلفاز والويب"';
  ...
  @override
  String get payPerView => 'الدفع مقابل المشاهدة';
  ...
  @override
  String get skipTrailer => 'تخطي المقدمة';

  @override
  String get moreEpisodes => 'المزيد من الحلقات';
  ...
  @override
  String get playOnTV => 'تشغيل على التلفاز';

  @override
  String get readyToCastToYourDevice => 'جاهز للبث إلى جهازك';

  @override
  String get castSupportInfo =>
      'يتم دعم الإرسال فقط لمقاطع الفيديو من نوع URL أو HLS أو المحلي. التنسيقات الأخرى غير مدعومة للإرسال.';
